...
<%-- 			<input type="hidden" name="Memeber_idx" value="${my_view.Member_idx}"> --%>
			...
			<tr>
				<td> 글번호 </td>
				<td>${my_review.board_id}</td>
			</tr>
			
			<tr>
				<td> 회원번호 </td>
				<td>${my_review.member_idx}</td>
			</tr>
			
			<tr>
				<td> 날짜 </td>
				<td>${my_review.b_date}</td>
			</tr>
			<tr>
				<td> 제목 </td>
				<td> <input type="text" name="b_title" value="${my_review.b_title}"></td>
			</tr>
			<tr>
				<td> 내용 </td>
				<td> <textarea rows="10" name="b_content" >${my_review.b_content}</textarea></td>
			</tr>
