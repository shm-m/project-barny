                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="navbarResponsive">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                                        <li></li>
                                        <a class="dropdown-item" href="/notice_list">공지사항</a>
                                </li>
                            ...
                            <ul class="timeline">
                                <li>
                                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                                            src="static/main_page/assets/img/review/review-1.png" alt="..." /></div>
                                    <div class="timeline-panel">
                                        ...
                                        <div class="timeline-body">
                                            <p class="text-muted">"퇴근 후 마트에서 아무 술이나 집어 스트레스를 해결하곤 했어요.
                                                이제는 바니를 통해 내 취향에 맞는 술을 즐길 수 있어요."</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="timeline-inverted">
                                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                                            src="static/main_page/assets/img/review/review-2.png" alt="..." /></div>
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                        ...
                                        <div class="timeline-body">
                                            <p class="text-muted">"전통주를 좋아하는데 시중에서는 구하기가 힘들어 곤란했어요.
                                                하지만 이제는 손쉽게 집에서 마실 수 있습니다."</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                                            src="static/main_page/assets/img/review/review-3.png" alt="..." /></div>
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4>밀키트까지 있어서</h4>
                                        ...
                                        <div class="timeline-body">
                                            <p class="text-muted">"자취하면서 친구들을 초대할 때 항상 준비가 힘들었는데 바니 덕분에
                                                음식과 술은 이제 걱정없습니다!" </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="timeline-inverted">
                                    <div class="timeline-image"><img class="rounded-circle img-fluid"
                                            src="static/main_page/assets/img/review/review-4.png" alt="..." /></div>
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4>삶의 질이 상승했어요</h4>
                                        ...
                                        <div class="timeline-body">
                                            <p class="text-muted">"바니를 구독한 이후로 와인에 관심이 생겨서 동호회까지 가입하게 되었어요.
                                                바니가 제 시야를 넓혀주었습니다."</p>
                                        </div>
                                    </div>
                                </li>
