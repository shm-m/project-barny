...
<body>
	<table id="list-table" width="500" cellpadding="0" cellspacing="0" border="1">
		<form action="${pageContext.request.contextPath}/notice/content/${content_view.board_id}" method="post">
			...
			<tr >
				<td colspan="2"><a href="${pageContext.request.contextPath}/notice">목록보기</a></td>
			</tr>
		</form>
	</table>
