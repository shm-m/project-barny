	        ...
	        $.ajax({
			    ...
			    success: function (result) {       
					if(result == "SUCCESS"){
						...
						$(location).attr('href', '${pageContext.request.contextPath}/admin/event/main')				      	       
					}					        
			    },
			    error: function (e) {
			        console.log(e);
...
<body>
	<table id="list-table" width="500" cellpadding="0" cellspacing="0" border="1">
		<form id="updateForm" action="${pageContext.request.contextPath}/admin/event/content/${content_view.board_id}" method="post">
			...
			<tr >
				<td colspan="2"><input type="submit" value="수정"> &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/admin/event/main">목록보기</a></td>
			</tr>
		</form>
	</table>
