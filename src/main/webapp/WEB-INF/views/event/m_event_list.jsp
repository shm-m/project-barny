  ...
  <body>
    ...
    <section class="page-section bg-light">
      <div class="container">
        ...
        <div
          class="card-group col d-flex justify-content-center"
          style="margin-left: 15px"
        >
          <div class="card">
            <a href="/user/event_cardbarny">
              <img src="/static/img/event1.png" class="card-img-top"
            /></a>
            <div class="card-body">
          ...
          <div class="card">
            <a href="..">
              <img src="/static/img/event2.png" class="card-img-top" alt="..."
            /></a>
            <div class="card-body">
          ...
          <div class="card">
            <a href="...">
              <img src="/static/img/event3.png" class="card-img-top" alt="..."
            /></a>
            <div class="card-body">
